          ...
          <div className="max-w-7xl px-6">
            <div className="max-w-2xl gap-x-16 lg:mx-0 lg:flex lg:max-w-none">
              <div className="pt-8 w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                <div className="mt-4 col-span-4 grid grid-cols-4 justify-center gap-10 mx-4 text-base font-medium leading-7 text-slate-800 sm:gap-8 lg:flex-col lg:gap-4">
                  {(
                    [
